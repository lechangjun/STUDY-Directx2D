...
void Sprite::Update(D3DXMATRIX& V, D3DXMATRIX& P)
{
	...
	D3DXMatrixRotationYawPitchRoll(&R, rotation.y,rotation.x,rotation.z);//Yaw = y, Pitch = x, Roll = z
...
void Sprite::CreateOBB(OUT OBBDesc * out, D3DXVECTOR2 & position, D3DXMATRIX & world, D3DXVECTOR2 & length)
{
	...
	out->Direction[0] = D3DXVECTOR2(world._11, world._12);//x축
	out->Direction[1] = D3DXVECTOR2(world._21, world._22);//y축
...
{
	float r1 = fabsf(D3DXVec2Dot(&seperate, &e1));//Dot = 내적
